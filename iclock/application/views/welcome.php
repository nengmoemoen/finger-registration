                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td data-label="sn"><?=$member['sn']?></td>
                            <td>
                                <span class="btn-operation">
                                    <a href="<?=base_url('index/erase_dev?userid='.$member['user_id'].'&sn='.$member['sn'])?>" class="button small secondary">Hapus alat</a>
                                    <a href="<?=base_url('index/add_dev?userid='.$member['user_id'].'&sn='.$member['sn'])?>" class="button small tertiary">Tambah alat</a>
                                </span>
                            </td>
                        </tr>
                    <?php endforeach; ?>
